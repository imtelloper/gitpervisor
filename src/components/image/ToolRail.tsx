...
export const TOOLS: readonly RailItem[] = [
  ...
  { id: "vpen", label: "펜", key: "P", icon: PenTool, flyout: ["pen", "highlight"], owner: 47, ready: false },
  { id: "curvature", label: "곡률", key: null, icon: Spline, owner: 47, ready: false },
  ...
  { id: "polygon", label: "다각형", key: null, icon: Pentagon, owner: 46, ready: false },
  ...
  { id: "callout", label: "말풍선", key: null, icon: MessageSquare, owner: 46, ready: false },
